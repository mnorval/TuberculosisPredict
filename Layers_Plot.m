...
layers = [
    ...
    batchNormalizationLayer('Name','MaxPool_1')
    reluLayer('Name','relu_1')
    
    convolution2dLayer(3,16,'Padding','same','Name','conv_2')
    reluLayer('Name','relu_2')
    batchNormalizationLayer('Name','AvgPool_1')
    
    convolution2dLayer(3,16,'Padding','same','Name','conv_3')
    reluLayer('Name','relu_3')
    batchNormalizationLayer('Name','AvgPool_2')
    
    batchNormalizationLayer('Name','FC_1')
    reluLayer('Name','relu_4')
    batchNormalizationLayer('Name','FC_2')
    batchNormalizationLayer('Name','Softmax')
    batchNormalizationLayer('Name','ClassOut')
